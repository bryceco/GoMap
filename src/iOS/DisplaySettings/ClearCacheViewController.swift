...
class ClearCacheViewController: UITableViewController {
	...
	override func viewWillAppear(_ animated: Bool) {
		...
		automaticCacheManagement.isOn = AppState.shared.settings.enableAutomaticCacheManagement
	}

	override func viewWillDisappear(_ animated: Bool) {
		super.viewWillDisappear(animated)

		AppState.shared.settings.enableAutomaticCacheManagement = automaticCacheManagement.isOn
	}
