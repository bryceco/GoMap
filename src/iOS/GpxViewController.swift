...
class GpxTrackTableCell: UITableViewCell, UIActionSheetDelegate {
	...
	@IBAction func doAction(_ sender: Any) {
		...
		alert.addAction(UIAlertAction(title: NSLocalizedString("Upload to OSM", comment: ""), style: .default, handler: { _ in
			self.tableView?.share(self.gpxTrack)
		}))
		alert.addAction(UIAlertAction(title: NSLocalizedString("Share", comment: "Open iOS sharing sheet"), style: .default, handler: { _ in
