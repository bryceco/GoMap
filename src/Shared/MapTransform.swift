...
final class MapTransform {
	...
	private static func FromBirdsEye(screenPoint point: OSMPoint, screenCenter center: CGPoint, birdsEyeDistance: Double, birdsEyeRotation: Double) -> OSMPoint {
		var point = point
	...
	private static func ToBirdsEye(screenPoint point: OSMPoint, screenCenter center: CGPoint, _ birdsEyeDistance: Double, _ birdsEyeRotation: Double) -> OSMPoint {
		var point = point
