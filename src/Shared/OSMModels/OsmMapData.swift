...
final class OsmMapData: NSObject, NSCoding {
	...
	func setupPeriodicSaveTimer() {
		...
		NotificationCenter.default.addObserver(forName: NSNotification.Name(MyUndoManager.UndoManagerDidChangeNotification), object: undoManager, queue: nil, using: { _ in
			let myself = weakSelf
			if myself == nil {
				return
			}
	...
	func sqlSaveNodes(_ saveNodes: [OsmNode], saveWays: [OsmWay], saveRelations: [OsmRelation], deleteNodes: [OsmNode], deleteWays: [OsmWay], deleteRelations: [OsmRelation], isUpdate: Bool) {
		...
		Database.dispatchQueue.async { [self] in
